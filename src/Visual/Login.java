...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        SetImageLabel(lblBiblio,"src/Imagen/Biblioteca_logo.png");
    }
    ...
    private void initComponents() {
        ...
        txtUsuario.setPreferredSize(new java.awt.Dimension(5, 25));

        Contraseña.setBackground(new java.awt.Color(255, 255, 255));
        Contraseña.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        Contraseña.setForeground(new java.awt.Color(0, 0, 0));
        Contraseña.setPreferredSize(new java.awt.Dimension(80, 25));
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        String pasw = Contraseña.getText();
        ...
        if (usuario.isEmpty() || pasw.isEmpty()) {
            ...
            if (usuario.equals("Biblioteca") && pasw.equals("2024")) {
                IngresarPDF b = new IngresarPDF();
                b.setVisible(true);
                this.dispose();
            } else {
